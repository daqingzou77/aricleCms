    ...
    const hotPhysics = [{
        ...
        description: ' 不论你身处何地、从事什么职业，实现一个目标的过程都是一样的。就好比上楼，得一步一步来，不能飞上去。如果你知道目标在何方，只要看着脚下，走你的路，终有一天，当你抬起头，伸出手，就会发现目标已近在咫尺。',
        ...
        description: '导读世界杯又仿佛人生，在经历了万千次拼搏和奋斗后，哪怕有一两次破门而入，实现自己的目标理想，都是值得欢呼雀跃的。既使踢成平局，也会因为曾经竭力防守和反击而不沮丧懊悔。',
        ...
        description: '催生足球明星的足球运动技战术本身以外,从体育本身、经济价值、文化层次、社会行为等诸方面的社会学思考来诠释足球明星的社会特征与价值,以使我们对足球明星价值理念进行理解与欣赏。',
