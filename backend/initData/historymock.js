    ...
    const historicalArticles = [{
        key: 'hot1',
        articlename: '《出师表》-诸葛亮',
        description: '臣亮言：先帝创业未半，而中道崩殂；今天下三分，益州疲敝，此诚危急存亡之秋也。然侍卫之臣，不懈于内；忠志之士，忘身于外者：盖追先帝之殊遇，欲报之于陛下也。诚宜开张圣听，以光先帝遗德，恢弘志士之气；不宜妄自菲薄，引喻失义，以塞忠谏之路也。',
        ...
        description: '永和九年，岁在癸丑，暮春之初，会于会稽山阴之兰亭，修禊事也。群贤毕至，少长咸集。此地有崇山峻岭，茂林修竹，又有清流激湍，映带左右，引以为流觞曲水，列坐其次。虽无丝竹管弦之盛，一觞一咏，亦足以畅叙幽情。',
        articleImgSrc: 'https://bkimg.cdn.bcebos.com/pic/7acb0a46f21fbe0993f0bda169600c338644addd?x-bce-process=image/resize,m_lfit,w_268,limit_1/format,f_jpg',
        ...
        key: 'hot3',
        articlename: '《六国论》-苏洵',
        description: '《六国论》是苏洵史论文代表作品。《六国论》提出并论证了六国灭亡“弊在赂秦”的精辟论点，“借古讽今”，抨击宋王朝对契丹和西夏的屈辱政策，告诫北宋统治者要吸取六国灭亡的教训，以免重蹈覆辙。',
        articleImgSrc: 'https://bkimg.cdn.bcebos.com/pic/adaf2edda3cc7cd982e65e133201213fb90e9134?x-bce-process=image/resize,m_lfit,w_268,limit_1/format,f_jpg',
        ...
        key: 'hot4',
        articlename: '《过秦论》-贾谊',
        description: '《过秦论》是贾谊政论散文的代表作，分上中下三篇。全文从各个方面分析秦王朝的过失，故名为《过秦论》。此文旨在总结秦速亡的历史教训，以作为汉王朝建立制度、巩固统治的借鉴，是一组见解深刻而又极富艺术感染力的文章。',
        ...
        description: '《报任安书》是汉代史学家、文学家司马迁写给其友人任安的一封回信。作者在信中以激愤的心情，陈述了自己的不幸遭遇，抒发了为著作《史记》而不得不含垢忍辱苟且偷生的痛苦心情。',
        articleImgSrc: 'https://bkimg.cdn.bcebos.com/pic/8cb1cb134954092381a4135d9258d109b2de49c7?x-bce-process=image/resize,m_lfit,w_268,limit_1/format,f_jpg',
        ...
        description: '信中拒绝了山涛的荐引，指出人的秉性各有所好，申明他自己赋性疏懒，不堪礼法约束，不可加以勉强。他强调放任自然，既是对世俗礼法的蔑视，也是他崇尚老庄无为思想的一种反映。文章风格清峻，立意超俗，行文精练。',
        articleImgSrc: 'https://bkimg.cdn.bcebos.com/pic/242dd42a2834349bb6c3c53cc8ea15ce37d3be46?x-bce-process=image/resize,m_lfit,w_268,limit_1/format,f_jpg',
        ...
        key: 'hot7',
        articlename: '《滕王阁序》-王勃',
        description: '《滕王阁序》是唐代文学家王勃创作的一篇骈文。文章由洪州的地势、人才写到宴会，写滕王阁的壮丽，眺望的广远，扣紧秋日，景色鲜明；再从宴会娱游写到人生遇合，抒发身世之感；接着写作者的遭遇并表白要自励志节，最后以应命赋诗和自谦之辞作结。',
