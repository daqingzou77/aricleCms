...
!(function(t) {
        ...
        t && t.preventDefault(),
          ...
          t.isDefaultPrevented() ||
            ...
            s.support.transition && o.hasClass('fade')
              ? o.one('bsTransitionEnd', n).emulateTransitionEnd(a.TRANSITION_DURATION)
              : n());
      });
    var t = s.fn.alert;
            ...
            s.proxy(function() {
              i[o](null == n[t] ? this.options[t] : n[t]),
                'loadingText' == t
                  ...
                  : this.isLoading && ((this.isLoading = !1), i.removeClass(e).removeAttr(e));
            }, this),
            0
          );
      }),
    ...
    (s.fn.button = i),
      ...
      s(document)
        .on('click.bs.button.data-api', '[data-toggle^="button"]', function(t) {
          ...
          i.call(e, 'toggle'),
            s(t.target).is('input[type="radio"]') ||
              s(t.target).is('input[type="checkbox"]') ||
              (t.preventDefault(),
              e.is('input,button')
                ? e.trigger('focus')
                : e
  ...
  (function(p) {
    ...
    (c.VERSION = '3.3.6'),
      ...
      (c.prototype.cycle = function(t) {
        return (
          ...
          this.options.interval &&
            !this.paused &&
            (this.interval = setInterval(p.proxy(this.next, this), this.options.interval)),
          this
        );
      }),
      ...
      (c.prototype.getItemForDirection = function(t, e) {
        ...
        if (
          (('prev' == t && 0 === i) || ('next' == t && i == this.$items.length - 1)) &&
          !this.options.wrap
        )
          return e;
  ...
  (function(l) {
    ...
    var h = function(t, e) {
      ...
      (this.options = e),
        ...
        !/#/.test(i) &&
          ...
          (o
            .find('.modal-content')
            .append('<iframe src="' + i + '" class="modal-iframe"></iframe>'),
          o.find('iframe.modal-iframe').load(function() {
            l(this).css('height', n.options.pageHeight),
              l.proxy(function() {
                o.trigger('loaded.bs.modal');
              }, this);
          }));
    };
    function s(a, r) {
      return this.each(function() {
        var t,
          ...
          o = l(this),
          n = o.data('bs.modal'),
          s = l.extend({}, h.DEFAULTS, o.data(), 'object' == typeof a && a);
        n ||
          (o.data('bs.modal', (n = new h(this, s))),
          (t = void 0 === (t = s.global) || t),
          (e = n.global = t ? parent : window),
          (i = n._document = e.document),
          (n.$body = l(i.body)),
          (n.flag = t)),
          'string' == typeof a ? n[a](r) : s.show && n.show(r);
      });
    }
    (h.VERSION = '3.3.6'),
      (h.DEFAULTS = { backdrop: !0, keyboard: !0, show: !0 }),
      ...
      (h.prototype.show = function(n) {
        var s = this,
          t = s.options.page,
          a = !/#/.test(t) && t,
          e = l.Event('show.bs.modal', { relatedTarget: n });
          ...
          this.isShown ||
            ...
            this.$dialog.on('mousedown.dismiss.bs.modal', function() {
              s.$element.one('mouseup.dismiss.bs.modal', function(t) {
                l(t.target).is(s.$element) && (s.ignoreBackdropClick = !0);
              });
            }),
            this.backdrop(function() {
              var t = l.support.transition && s.$element.hasClass('fade');
              if ((s.$element.parent().length || s.$element.appendTo(s.$body), s.flag)) {
                var e = s.$element.attr('id');
                s.$element.after('<div id="' + e + '-admui"></div>'),
                  s.$element
                    .appendTo(s.$body)
                    .show()
                    .scrollTop(0);
              } else s.$element.show().scrollTop(0);
              a
                ? s.$element.find('iframe').one('load', function() {
                    var t = l(this).prop('contentWindow').document;
                    l(t).on('click.dismiss.bs.modal', '[data-dismiss="modal"]', l.proxy(s.hide, s));
                  })
                : s.$element.on(
                ...
                s.enforceFocus();
              var i = l.Event('shown.bs.modal', { relatedTarget: n }),
                o = function() {
                  s.$dialog.find('iframe').one('load', function() {
                    s.$element.trigger('focus').trigger(i);
                  });
                };
              t
                ? a
      ...
      (h.prototype.hide = function(t) {
        t && t.preventDefault(),
          ...
          this.isShown &&
            ...
            this.escape(),
            this.resize(),
            l(document).off('focusin.bs.modal'),
            this.$element
              .removeClass('in')
              .off('click.dismiss.bs.modal')
              .off('mouseup.dismiss.bs.modal'),
            this.$dialog.off('mousedown.dismiss.bs.modal'),
            l.support.transition && this.$element.hasClass('fade')
              ? this.$element
                  .one('bsTransitionEnd', l.proxy(this.hideModal, this))
                  .emulateTransitionEnd(h.TRANSITION_DURATION)
              : this.hideModal());
      }),
      ...
      (h.prototype.resize = function() {
        var t = this.global;
        this.isShown
          ? l(t).on('resize.bs.modal', l.proxy(this.handleUpdate, this))
          : l(t).off('resize.bs.modal');
      }),
      (h.prototype.iframeAuto = function() {
        var t,
          e = this.options.page;
        !/#/.test(e) &&
          e &&
          this.isShown &&
          (t = this.$element.find('iframe')).css({
            height: t
              .contents()
              .find('html')
              .outerHeight(),
      ...
      (h.prototype.backdrop = function(t) {
        var e = this,
          i = this.$element.hasClass('fade') ? 'fade' : '';
        if (this.isShown && this.options.backdrop) {
          var o = l.support.transition && i;
          if (
            ((this.$backdrop = l(e._document.createElement('div'))
              .addClass('modal-backdrop ' + i)
              .appendTo(this.$body)),
            this.$element.on(
              'click.dismiss.bs.modal',
              l.proxy(function(t) {
                this.ignoreBackdropClick && (this.ignoreBackdropClick = !1),
            ...
            return;
          o ? this.$backdrop.one('bsTransitionEnd', t) : t();
          ...
          l.support.transition && this.$element.hasClass('fade')
            ? this.$backdrop.one('bsTransitionEnd', n)
            : n();
        } else t && t();
      }),
      (h.prototype.handleUpdate = function() {
        this.adjustDialog(), this.iframeAuto();
      }),
      (h.prototype.adjustDialog = function() {
        var t = this.$element[0].scrollHeight > this._document.documentElement.clientHeight;
        this.$element.css({
      ...
      (h.prototype.checkScrollbar = function() {
        var t = this.global.innerWidth;
        if (!t) {
          var e = document.documentElement.getBoundingClientRect();
          t = e.right - Math.abs(e.left);
        }
        (this.bodyIsOverflowing = this._document.body.clientWidth < t),
    ...
    var t = l.fn.modal;
    (l.fn.modal = s),
      (l.fn.modal.Constructor = h),
      (l.fn.modal.noConflict = function() {
        return (l.fn.modal = t), this;
      }),
      l(document).on('click.bs.modal.data-api', '[data-toggle="modal"]', function(t) {
        var e = l(this),
          i = e.attr('href'),
          o = l(e.attr('data-target') || (i && i.replace(/.*(?=#[^\s]+$)/, ''))),
          n = o.data('bs.modal')
            ? 'toggle'
            : l.extend({ remote: !/#/.test(i) && i }, o.data(), e.data());
  ...
  (function(g) {
    ...
    (m.VERSION = '3.3.6'),
      ...
      (m.prototype.init = function(t, e, i) {
        ...
        this.options.selector
          ? (this._options = g.extend({}, this.options, { trigger: 'manual', selector: '' }))
          : this.fixTitle();
      }),
      ...
      (m.prototype.getOptions = function(t) {
        return (
          (t = g.extend({}, this.getDefaults(), this.$element.data(), t)).delay &&
      ...
      (m.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          g.support.transition && this.$tip.hasClass('fade')
            ? o.one('bsTransitionEnd', u).emulateTransitionEnd(m.TRANSITION_DURATION)
            : u();
        }
      }),
        ...
        if ((this.$element.trigger(o), !o.isDefaultPrevented()))
          return (
            ...
            g.support.transition && i.hasClass('fade')
              ? i.one('bsTransitionEnd', n).emulateTransitionEnd(m.TRANSITION_DURATION)
              : n(),
            (this.hoverState = null),
            this
          );
      ...
      (m.prototype.getPosition = function(t) {
        ...
        null == o.width &&
          (o = g.extend({}, o, { width: o.right - o.left, height: o.bottom - o.top }));
    ...
    (g.fn.tooltip = function(o) {
      return this.each(function() {
        ...
        (!e && /destroy|hide/.test(o)) ||
          (e || t.data('bs.tooltip', (e = new m(this, i))), 'string' == typeof o && e[o]());
      });
    }),
    ...
    (n.fn.popover = function(o) {
      return this.each(function() {
        var t = n(this),
          ...
          i = 'object' == typeof o && o;
        (!e && /destroy|hide/.test(o)) ||
          (e || t.data('bs.popover', (e = new s(this, i))), 'string' == typeof o && e[o]());
      });
    }),
        ...
        function s() {
          o
            ...
            t
              ...
              .find('[data-toggle="tab"]')
              .attr('aria-expanded', !0),
            n ? t[0].offsetWidthelement.addClass('in') : t.removeClass('fade'),
    ...
    var h = function(t, e) {
      (this.options = l.extend({}, h.DEFAULTS, e)),
        (this.$target = l(this.options.target)
          ...
          .on('click.bs.affix.data-api', l.proxy(this.checkPositionWithEventLoop, this))),
        (this.$element = l(t)),
        (this.affixed = null),
        (this.unpin = null),
